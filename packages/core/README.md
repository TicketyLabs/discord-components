...
# @tickety/discord-components-core
...
- [@tickety/discord-components-core](#ticketydiscord-components-core)
...
```bash
yarn add @tickety/discord-components-core
# or pnpm add @tickety/discord-components-core
# or npm install @tickety/discord-components-core
```
...
`import '@tickety/discord-components-core'`) the module augmentations should
...
```ts
import type { DiscordMessageOptions } from '@tickety/discord-components-core';
...
(`import { setConfig } from '@tickety/discord-components-core'`).
