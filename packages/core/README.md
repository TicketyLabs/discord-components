...
# @ticketylabs/discord-components-core
...
- [@ticketylabs/discord-components-core](#ticketydiscord-components-core)
...
```bash
yarn add @ticketylabs/discord-components-core
# or pnpm add @ticketylabs/discord-components-core
# or npm install @ticketylabs/discord-components-core
```
...
`import '@ticketylabs/discord-components-core'`) the module augmentations should
...
```ts
import type { DiscordMessageOptions } from '@ticketylabs/discord-components-core';
...
(`import { setConfig } from '@ticketylabs/discord-components-core'`).
