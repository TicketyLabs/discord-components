import * as ReactComponents from 'discord-components-core';
...
export type { Avatars, DiscordMessageOptions, DiscordTimestamp, Emoji, LightTheme, Profile } from 'discord-components-core';
export { getConfig, setConfig } from 'discord-components-core';
